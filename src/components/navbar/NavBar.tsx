      ...
      <div className="container mx-auto px-4 py-3 md:py-4 flex ">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center">
            ...
            <NavLink to="/ask-imam">Ask Imam</NavLink>
          </div>
        </div>
      </div>
    </nav>
...
function NavLink({ children, className = "", ...props }: NavLinkProps) {
  return (
    <Link
      className={`block px-3 py-2 rounded-md text-base hover:bg-teal-600 whitespace-nowrap hover:text-white transition duration-150 ease-in-out md:inline-block md:mt-0 md:ml-4 font-bold ${className}`}
      {...props}
    >
      {children}
    </Link>
